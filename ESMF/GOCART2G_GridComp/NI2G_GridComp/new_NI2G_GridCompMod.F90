...
!  !Nitrate state
   ...
   type, extends(GA_Environment) :: NI2G_GridComp
       ...
       !real, allocatable :: xhno3(:,:,:)   ! buffer for NITRATE_HNO3 [mol mol-1]; moved to ESMF internal state
...
!   -------------------
    ...
    call ESMF_ConfigGetAttribute(cfg, self%using_GMI2, label='using_GMI2:', __RC__)    
