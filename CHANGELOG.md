...
- Fixed optical properties computation in GOCART2G, renamed `aerosol_monochromatic_optics_wavelength:` to
  `aerosol_monochromatic_optics_wavelength_in_nm`, made sure they were in nm, and cleaned up RC files
